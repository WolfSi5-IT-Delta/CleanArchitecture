      ...
      <Header title={lesson.id === undefined
          ...
          <ul>
            ...
            <li className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <div
                className="shadow-sm border-[1px] focus:ring-indigo-500 focus:border-indigo-500 block w-full mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 border-gray-300 rounded-md"
              >
                <Editor
