    ...
    <main>
      <div className="border-t border-gray-200 bg-white shadow rounded-xl">
        ...
        <ul>
          ...
          <li className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 align-items-center">
            <span className="text-sm font-medium text-gray-500">{t('common:email')}</span>
            <input
              type="email"
              value={data.email}
          ...
          <li className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 align-items-center">
            <span className="text-sm font-medium text-gray-500">{t('common:phone')}</span>
            <input
              type="tel"
              value={data.phone}
          ...
          <li className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 align-items-center">
            <span className="text-sm font-medium text-gray-500">{t('users:password')}</span>
          ...
          <li className="bg-white px-4 py-5 grid grid-cols-2 sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <span className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  <Switch
                    ...
                    `}
                  >
                    <span className="sr-only">{t('users:administrator')}</span>
                    <span
                      className={`
          ...
          <li className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <span className="text-sm font-medium text-gray-500 flex items-center sm:block">{t('users:accesses')}</span>
            <span className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <Access
